...
data/PW_cat_depth_False_candidats_bySample.csv is the concatenation of 10 tests files (one by sample) depth_False_candidats.csv generated by data/complete_candidat_file.sh .
...
Input file 'data/cat_pw_candidates.Cglen.intron.Cdlen.DPratio.RI.JC.csv' is used for B, C and D graphs.
Input file 'cat_pw_candidates.Cglen.intron.Cdlen.DPratio.RI.JC.csv' is the concatenation of 10 files (1 par sample) candidates.Cglen.intron.Cdlen.DPratio.RI.JC.csv, generated by data/complete_candidat_file.sh .
