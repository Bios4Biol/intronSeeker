...
data/PW_cat_depth_False_candidats_bySample.csv is the concatenation of 10 tests files (1 by sample) depth_False_candidats.csv generated by data/complete_candidat_file.sh
