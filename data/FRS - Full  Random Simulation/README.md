...
(ISeeker_environment) bash-4.4$ ls -ltrah
-rw-r--r-- 1 smaman SIGENAE 1005 Jul 17 09:26 grinder_frs.cfg
drwxr-xr-x 2 smaman SIGENAE 4.0K Aug 28 09:45 sampleFRS
-rw-r--r-- 1 smaman SIGENAE  20K Aug 28 10:06 sr_ranks.txt
-rw-r--r-- 1 smaman SIGENAE  241 Aug 28 10:17 sr.log
-rw-r--r-- 1 smaman SIGENAE  51M Aug 28 10:20 sr_R2.fastq.gz
-rw-r--r-- 1 smaman SIGENAE  51M Aug 28 10:20 sr_R1.fastq.gz
```
...
total 65M
drwxr-xr-x 4 smaman SIGENAE 4.0K Aug 28 10:35 ..
drwxr-xr-x 2 smaman SIGENAE 4.0K Aug 28 10:35 star_genomeRef
-rw-r--r-- 1 smaman SIGENAE  42K Aug 28 10:36 star.star.Log.out
-rw-r--r-- 1 smaman SIGENAE  65M Aug 28 10:36 star.sort.bam
-rw-r--r-- 1 smaman SIGENAE  79K Aug 28 10:36 star.sort.bai
-rw-r--r-- 1 smaman SIGENAE  514 Aug 28 10:36 star.sort.flagstat.txt
-rw-r--r-- 1 smaman SIGENAE  706 Aug 28 10:36 star.log
drwxr-xr-x 3 smaman SIGENAE 4.0K Aug 28 10:36 .
```
...
Results files for STAR alignment:
```diff
(ISeeker_environment) bash-4.4$ ls -ltrah HISAT2_alignment/
drwxr-xr-x 2 smaman SIGENAE 4.0K Aug 28 11:02 hisat2_genomeRef
-rw-r--r-- 1 smaman SIGENAE 6.3K Aug 28 11:02 hisat2_build.log
-rw-r--r-- 1 smaman SIGENAE  17K Aug 28 11:03 hisat2_aln.log
-rw-r--r-- 1 smaman SIGENAE  71M Aug 28 11:03 hisat2.sort.bam
-rw-r--r-- 1 smaman SIGENAE  79K Aug 28 11:03 hisat2.sort.bai
-rw-r--r-- 1 smaman SIGENAE  513 Aug 28 11:03 hisat2.sort.flagstat.txt
-rw-r--r-- 1 smaman SIGENAE  551 Aug 28 11:03 hisat2.log
```
...
```diff
(ISeeker_environment) bash-4.4$ ls -ltrah SRS_HISAT2/
-rw-r--r-- 1 smaman SIGENAE 8.3M Aug 28 11:17 srs_split_alignments.txt
-rw-r--r-- 1 smaman SIGENAE  80K Aug 28 11:17 srs_candidates.txt
```	
...
```diff
(ISeeker_environment) bash-4.4$ ls -ltrah HTML/
-rw-r--r-- 1 smaman SIGENAE  49K Aug 28 11:21 report_FRS.html
```
