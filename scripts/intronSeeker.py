...
def parse_arguments() :
    ...
    parser_star.add_argument('-r','--reference',
    ...
    parser_star.add_argument('-o','--prefix',
                             help='output prefix', type=str, dest='prefix')
    ...
    parser_hisat2.add_argument('-t','--threads',
                               help='number of threads used to perform alignement', type=int, default=1, dest='threads')
    parser_hisat2.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_split.add_argument('-i', '--input',
                              help='input bam file from alignment', dest='bamfilename', type=str, )
    parser_split.add_argument('-r', '--reference',
                              help='name of the reference file used for the alignment', type=str, dest='fastafilename')
    parser_split.add_argument('-o','--prefix',
                              help='prefix of ouput files',type=str, dest='basename')
    parser_split.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_trunc.add_argument('-i', '--fasta',
                              help='Fasta with sequences to splice', dest='fasta_file', type=str, )
    parser_trunc.add_argument('-g', '--gff', 
                              help='File with features to delete (GFF format only)', dest='gff_feature', type=str, )
    parser_trunc.add_argument('-o','--output',
                              help='Basename of the output file', dest='output', type=str, default='sequences')
    parser_trunc.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_orf.add_argument('-i', '--fasta', 
                            help='Sequences on which the prediction will be performed', dest='fasta_file', type=str, )
    ...
    parser_orf.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_protein.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_gbs.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_grinder.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
    ...
    parser_install.add_argument('-h','--help',action='store_const', const = parser_star.prog.split()[-1],dest='c_help')
